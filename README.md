...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-18 18:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c3a5a05d-481f-4d05-b537-0a998841abf6.git
$ cd c3a5a05d-481f-4d05-b537-0a998841abf6
```
